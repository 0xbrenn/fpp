...
// PREMIUM DARK THEME P2P MARKETPLACE - With themed cards
...
const SecondaryMarketplace = () => {
  ...
  // Helper function to format percentages with proper precision
  ...
  // Helper to get exact percentage display
      ...
      const enrichedListings = await Promise.all(
        rawListings.map(async (listing) => {
          try {
            ...
            if (isWeighted) {
              // For weighted assets, convert from wei (1e18 = 100%)
    ...
    <div className="min-h-screen bg-black">
      <div className="max-w-[1920px] mx-auto">
        ...
        <div className="bg-gradient-to-b from-neutral-950 to-black border-b border-neutral-900">
          <div className="px-6 lg:px-8 py-8">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h1 className="text-3xl font-light text-white mb-2">P2P Marketplace</h1>
                <p className="text-neutral-500">Trade verified positions directly with other users</p>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-black/50 backdrop-blur-sm border border-neutral-800 rounded-xl p-6">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-xs text-neutral-600 uppercase tracking-wider">Active Listings</p>
                  <BarChart3 className="w-4 h-4 text-neutral-600" />
                </div>
                <p className="text-2xl font-light text-white">{listings.length}</p>
                <p className="text-xs text-green-500 mt-1">+12% this week</p>
              </div>

              <div className="bg-black/50 backdrop-blur-sm border border-neutral-800 rounded-xl p-6">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-xs text-neutral-600 uppercase tracking-wider">Total Volume</p>
                  <TrendingUp className="w-4 h-4 text-neutral-600" />
                </div>
                <p className="text-2xl font-light text-white">{totalVolume} OPN</p>
                <p className="text-xs text-neutral-500 mt-1">≈ ${convertToUSD(totalVolume)}</p>
              </div>

              <div className="bg-black/50 backdrop-blur-sm border border-neutral-800 rounded-xl p-6">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-xs text-neutral-600 uppercase tracking-wider">Unique Assets</p>
                  <Gem className="w-4 h-4 text-neutral-600" />
                </div>
                <p className="text-2xl font-light text-white">{uniqueAssets}</p>
                <p className="text-xs text-blue-500 mt-1">Verified assets</p>
              </div>
              ...
              <div className="bg-black/50 backdrop-blur-sm border border-neutral-800 rounded-xl p-6">
                ...
                <p className="text-2xl font-light text-white">{averagePrice} OPN</p>
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  placeholder="Search assets, types, or sellers..."
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-24 px-3 py-2 bg-black border border-neutral-800 rounded-lg text-white text-sm"
                    />
        ...
        <div className="px-6 lg:px-8 py-3 bg-black/50 border-b border-neutral-900 flex items-center justify-between">
          <p className="text-sm text-neutral-400">
            ...
            {activeFilterCount > 0 && <span> matching your criteria</span>}
          </p>
        ...
        <div className="px-6 lg:px-8 py-8">
          {filteredAndSortedListings.length === 0 ? (
            <div className="text-center py-32">
              ...
              <h3 className="text-2xl font-light text-white mb-2">No listings found</h3>
            ...
            // Grid View - THEMED LIKE MARKETPLACE CARDS
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {currentListings.map((listing) => (
                ...
                >
                  {/* Image Section - Themed like marketplace */}
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="pb-3 border-b border-neutral-800">
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-neutral-400">List Price</span>
                          <div className="text-right">
                            <p className="text-lg font-semibold text-white">{listing.price} OPN</p>
                      ...
                      {/* Secondary Info */}
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-neutral-400">Listed</span>
                      ...
                      {/* Seller Preview */}
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-neutral-400">Seller</span>
            ...
            // Premium List View - THEMED
            <div className="space-y-4">
              {currentListings.map((listing) => (
                <div
                  key={listing.listingId}
                  className="group bg-gradient-to-r from-neutral-900/50 to-black border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-all cursor-pointer"
                  onClick={() => setSelectedListing(listing)}
                >
                  <div className="flex items-center gap-6">
                    {/* Image */}
                    <div className="w-24 h-24 bg-gradient-to-br from-neutral-900 to-neutral-950 rounded-xl overflow-hidden flex-shrink-0">
                      {listing.assetImageUrl ? (
                        <img
                          src={listing.assetImageUrl}
                          alt={listing.assetName}
                    ...
                    <div className="flex-1 grid grid-cols-1 lg:grid-cols-4 gap-4 items-center">
                      <div className="lg:col-span-2">
                        ...
                        <h4 className="font-medium text-white text-lg">{listing.assetName}</h4>
                        <div className="flex items-center gap-3 mt-2">
                          {listing.isWeighted && (
                            <span className="text-xs text-purple-400">Weighted Model</span>
                          )}
                          {listing.isPartialSale && (
                      ...
                      <div className="text-center">
                        <p className="text-sm text-neutral-500 mb-1">Ownership</p>
                        <p className="text-xl font-medium text-white">{listing.displayPercentage}</p>
                        {!listing.isWeighted && (
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-2xl font-semibold text-white">{listing.price} OPN</p>
                        <p className="text-xs text-neutral-500">≈ ${convertToUSD(listing.price)} • +{(parseFloat(listing.price) * 0.02).toFixed(2)} fee</p>
                      </div>
                    </div>
      ...
      {selectedListing && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-gradient-to-b from-neutral-900 to-black border border-neutral-800 rounded-2xl max-w-lg w-full shadow-2xl">
            {/* Modal Header */}
            ...
            <div className="p-6">
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="w-20 h-20 bg-gradient-to-br from-neutral-800 to-neutral-900 rounded-xl overflow-hidden flex-shrink-0">
                ...
                <div>
                  <p className="text-xs text-neutral-500 uppercase tracking-wider">{selectedListing.assetType}</p>
                  <h3 className="text-lg font-medium text-white mb-1">{selectedListing.assetName}</h3>
                  <div className="flex items-center gap-3 text-sm">
                    <span className="text-neutral-400">{selectedListing.displayAmount}</span>
                    <span className="text-neutral-600">•</span>
                ...
                <div className="space-y-3">
                  ...
                  <div className="pt-3 border-t border-neutral-800 flex justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-neutral-500">≈ ${convertToUSD((parseFloat(selectedListing.price) * 1.02).toFixed(2))} USD</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Seller Info */}
              <div className="flex items-center justify-between p-4 bg-black/30 border border-neutral-800 rounded-xl mb-6">
              ...
              {selectedListing.seller.toLowerCase() === address?.toLowerCase() ? (
                <button
                  ...
                  disabled={cancelling}
                  className="w-full py-4 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 disabled:from-neutral-800 disabled:to-neutral-800 disabled:text-neutral-500 text-white font-medium rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-red-600/20"
                >
                  {cancelling ? (
                    <>
                ...
                <button
                  ...
                  disabled={buying}
                  className="w-full py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 disabled:from-neutral-800 disabled:to-neutral-800 disabled:text-neutral-500 text-white font-medium rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-blue-600/20"
                >
                  {buying ? (
                    <>
                      <Loader2 className="w-5 h-5 animate-spin" />
