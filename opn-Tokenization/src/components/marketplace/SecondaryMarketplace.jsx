        ...
        <div className="bg-neutral-950 border-b border-neutral-900 sticky top-0 z-20 backdrop-blur-sm bg-opacity-95">
          <div className="px-3 sm:px-6 lg:px-8 py-3 sm:py-4">
            <div className="flex flex-col gap-3 sm:gap-4">
              ...
              {/* Filter Controls - MOBILE SCROLL ✅ FIXED */}
              <div className="flex gap-2 overflow-x-auto scrollbar-hide pb-2 sm:flex-wrap sm:overflow-visible">
                {/* Asset Type */}
                <select
                  value={filterAssetType}
                  onChange={(e) => setFilterAssetType(e.target.value)}
                  className="flex-shrink-0 min-w-[120px] sm:w-auto px-3 sm:px-4 py-2 sm:py-3 bg-black border border-neutral-800 rounded-xl text-white text-xs sm:text-sm focus:outline-none focus:border-blue-500 transition-all"
                >
                ...
                <button
                  ...
                  className={`flex-shrink-0 px-3 sm:px-4 py-2 sm:py-3 border rounded-xl transition-all flex items-center gap-2 text-xs sm:text-sm ${
