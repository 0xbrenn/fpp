...
// FIXED - Entire card is clickable for better UX
...
const AssetCard = ({ asset, onBuyClick, viewMode = 'grid' }) => {
          ...
          <div className="flex-1 grid grid-cols-1 lg:grid-cols-4 gap-4 items-center">
            ...
            <div className="flex items-center gap-8">
              ...
              <div>
                ...
                <p className="text-xl font-light text-white">{availability.available}</p>
                <p className="text-xs text-neutral-500">Ownership sold: {availability.sold}</p>
              </div>
            </div>

            {/* Action - Just visual, card handles click */}
  ...
  // Premium Grid View - Entire card is clickable
  return (
    <div 
      onClick={handleCardClick}
