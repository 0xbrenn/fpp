...
// ENHANCED - Better badge visibility with dark backgrounds
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-48 h-32 bg-neutral-900 rounded-lg overflow-hidden flex-shrink-0 relative">
            ...
            <div className="absolute top-2 left-2 flex gap-2">
              <span className="px-2 py-1 bg-black/90 backdrop-blur-sm text-xs font-semibold text-white rounded-sm border border-white/20 shadow-lg">
                {asset.assetType}
              </span>
            </div>
            
            <div className="absolute top-2 right-2">
              <span className={`px-2 py-1 backdrop-blur-sm text-xs font-semibold rounded-sm shadow-lg border ${
                isWeighted 
