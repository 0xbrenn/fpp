...
const AssetCard = ({ asset, onBuyClick }) => {
  // Safely convert BigNumber values to numbers
  const totalShares = asset.totalShares ? parseFloat(ethers.utils.formatEther(asset.totalShares)) : 0;
  const availableShares = asset.availableShares ? parseFloat(ethers.utils.formatEther(asset.availableShares)) : 0;
  const pricePerShare = asset.pricePerShare ? parseFloat(ethers.utils.formatEther(asset.pricePerShare)) : 0;
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div>
            ...
            <p className="text-sm font-normal text-white">{formatNumber(pricePerShare)} OPN</p>
          </div>
          <div>
