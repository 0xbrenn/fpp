...
// FIXED - Mobile horizontal scroll for filters and categories
  ...
  return (
    <div className="min-h-screen bg-black">
      <div className="max-w-[1920px] mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
              <div className="bg-black/50 backdrop-blur-sm border border-neutral-800 rounded-lg p-2.5 sm:p-6 min-w-0">
                <div className="flex items-start justify-between mb-1.5">
                  ...
                  <Package className="w-3 h-3 sm:w-4 sm:h-4 text-neutral-600 flex-shrink-0" />
                </div>
                <p className="text-2xl sm:text-2xl font-light text-white mb-0.5 text-center sm:text-left">{totalAssetCount}</p>
                <p className="text-[8px] sm:text-xs text-green-500 text-center sm:text-left">Listed</p>
              </div>
              ...
              <div className="bg-black/50 backdrop-blur-sm border border-neutral-800 rounded-lg p-2.5 sm:p-6 min-w-0">
                ...
                <p className="text-2xl sm:text-2xl font-light text-white mb-0.5 text-center sm:text-left">{availableAssetsCount}</p>
              ...
              <div className="bg-black/50 backdrop-blur-sm border border-neutral-800 rounded-lg p-2.5 sm:p-6 min-w-0">
                ...
                <p className="text-2xl sm:text-2xl font-light text-white mb-0.5 truncate text-center sm:text-left">
                  {parseFloat(ethers.utils.formatEther(totalValue)).toLocaleString(undefined, { maximumFractionDigits: 0 })}
                </p>
              ...
              <div className="bg-black/50 backdrop-blur-sm border border-neutral-800 rounded-lg p-2.5 sm:p-6 min-w-0">
                <div className="flex items-start justify-between mb-1.5">
                  ...
                  <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 text-neutral-600 flex-shrink-0" />
                </div>
                <p className="text-2xl sm:text-2xl font-light text-white mb-0.5 truncate text-center sm:text-left">{averagePrice.toFixed(0)}</p>
                <p className="text-[8px] sm:text-xs text-neutral-500 text-center sm:text-left">OPN</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-neutral-950 border-b border-neutral-900 sticky top-0 z-20 backdrop-blur-sm bg-opacity-95">
          <div className="px-3 sm:px-6 lg:px-8 py-3 sm:py-4">
            <div className="flex flex-col gap-3 sm:gap-4">
              ...
              {/* Filter Controls - ✅ FIXED: Horizontal scroll on mobile */}
              <div className="flex gap-2 overflow-x-auto pb-2 -mx-3 px-3 sm:mx-0 sm:px-0 scrollbar-hide">
                {/* Filter Button */}
                <button
                  onClick={() => setShowFilters(!showFilters)}
                  className={`flex-shrink-0 px-3 py-2.5 rounded-xl font-medium transition-all flex items-center gap-2 text-xs ${
                    showFilters
                ...
                <select
                  ...
                  className="flex-shrink-0 px-3 py-2.5 bg-black border border-neutral-800 rounded-xl text-white text-xs focus:outline-none focus:border-blue-500 transition-all min-w-[110px]"
                >
                ...
                <select
                  ...
                  className="flex-shrink-0 px-3 py-2.5 bg-black border border-neutral-800 rounded-xl text-white text-xs focus:outline-none focus:border-blue-500 transition-all min-w-[120px]"
                >
        ...
        {/* Category Navigation - ✅ FIXED: Horizontal scroll on mobile */}
        <div className="bg-black/50 border-b border-neutral-900">
          <div className="px-3 sm:px-6 lg:px-8">
            <nav className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide -mx-3 px-3 sm:mx-0 sm:px-0">
              {categories.map((category) => {
                ...
                return (
                  <button
                    ...
                    className={`
                      flex-shrink-0 flex items-center gap-2 px-1 py-3 sm:py-4
