...
// FIXED VERSION - Works with new 5-contract architecture + refresh on purchase
    ...
    try {
      ...
      const propertyPromises = activeAssetIds.map(async (assetId) => {
        try {
          ...
          const isVehicle = asset.assetType.toLowerCase().includes('vehicle') || 
                           asset.assetType.toLowerCase().includes('car');
