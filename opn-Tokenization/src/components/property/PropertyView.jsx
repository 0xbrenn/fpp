...
// PREMIUM DARK THEME - Mobile Responsive - FIXED ROUTING - WITH SOLD OUT FILTER
...
const PropertyView = () => {
  ...
  const [availabilityFilter, setAvailabilityFilter] = useState('all'); // all, available, sold-out
  ...
  const handleViewDetails = (property) => {
    navigate(`/realestate/${property.assetId}`);
  };
  ...
  const filteredAndSortedProperties = React.useMemo(() => {
    ...
    return filtered;
  }, [properties, searchQuery, filter, availabilityFilter, sortBy]);
            ...
            <div className="flex flex-col gap-3 sm:gap-4">
              ...
              <div className="grid grid-cols-2 sm:flex gap-2 flex-wrap">
                ...
                <select
                  ...
                  className="px-3 sm:px-4 py-2 sm:py-3 bg-black border border-neutral-800 rounded-xl text-white text-xs sm:text-sm focus:outline-none focus:border-blue-500 transition-all"
                >
                        ...
                        <div className="flex-1 w-full space-y-3">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-1.5 sm:gap-2 mb-2 flex-wrap">
                              <span className="px-2 py-1 bg-neutral-800 text-white text-[10px] sm:text-xs rounded-lg flex items-center gap-1">
          ...
          {!loading && filteredAndSortedProperties.length === 0 && (
            <div className="text-center py-20 sm:py-32 px-4">
              ...
              <p className="text-sm sm:text-base text-neutral-500 mb-6 sm:mb-8 max-w-md mx-auto">
                {searchQuery || filter !== 'all' || availabilityFilter !== 'all'
