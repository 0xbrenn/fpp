...
// PREMIUM DARK THEME - Fixed wei units percentage calculations
        ...
        <div className="bg-gradient-to-b from-neutral-950 to-black border-b border-neutral-900">
          <div className="px-6 lg:px-8 py-8">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h1 className="text-3xl font-light text-white mb-2">Real Estate Properties</h1>
                <p className="text-neutral-500">Discover and invest in fractional real estate ownership</p>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-black/50 backdrop-blur-sm border border-neutral-800 rounded-xl p-6">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-xs text-neutral-600 uppercase tracking-wider">Total Properties</p>
                  <Building className="w-4 h-4 text-neutral-600" />
                </div>
                <p className="text-2xl font-light text-white">{totalProperties}</p>
              ...
              <div className="bg-black/50 backdrop-blur-sm border border-neutral-800 rounded-xl p-6">
                ...
                <p className="text-2xl font-light text-white">{availableProperties}</p>
                <p className="text-xs text-blue-500 mt-1">Open for investment</p>
              </div>
              ...
              <div className="bg-black/50 backdrop-blur-sm border border-neutral-800 rounded-xl p-6">
                ...
                <p className="text-2xl font-light text-white">{totalValue.toLocaleString(undefined, { maximumFractionDigits: 0 })} OPN</p>
                <p className="text-xs text-neutral-500 mt-1">≈ ${convertToUSD(totalValue)}</p>
              </div>

              <div className="bg-black/50 backdrop-blur-sm border border-neutral-800 rounded-xl p-6">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-xs text-neutral-600 uppercase tracking-wider">Avg Value</p>
                  <BarChart3 className="w-4 h-4 text-neutral-600" />
                </div>
                <p className="text-2xl font-light text-white">{averageValue.toLocaleString(undefined, { maximumFractionDigits: 0 })} OPN</p>
                <p className="text-xs text-neutral-500 mt-1">≈ ${convertToUSD(averageValue)}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="px-6 lg:px-8 py-8">
          ...
          {!loading && filteredAndSortedProperties.length > 0 && (
            viewMode === 'grid' ? (
              ...
              // Premium List View - Matching AssetCard list design
                      ...
                      <div className="flex items-center gap-6">
                        ...
                        <div className="w-48 h-32 bg-gradient-to-br from-neutral-900 to-neutral-950 rounded-xl overflow-hidden flex-shrink-0 relative">
                          ...
                          <div className="absolute top-3 left-3 flex gap-2">
                            ...
                            <span className="px-2 py-1 bg-green-600/80 backdrop-blur-sm text-white text-xs rounded-lg flex items-center gap-1">
                              <CheckCircle className="w-3 h-3" />
                              Verified
                            </span>
                            {isWeighted ? (
                              <span className="px-2 py-1 bg-purple-600/80 backdrop-blur-sm text-white text-xs rounded-lg">
                                Weighted
                              </span>
                            ) : (
                              <span className="px-2 py-1 bg-blue-600/80 backdrop-blur-sm text-white text-xs rounded-lg">
                                Fixed
                              </span>
                            )}
                          </div>
                        ...
                        <div className="flex-1 grid grid-cols-1 lg:grid-cols-4 gap-4 items-center">
                          ...
                          <div className="lg:col-span-2">
                            ...
                            <div className="flex items-center gap-3 text-xs">
                              <div className="flex items-center gap-1 text-neutral-400">
                                ...
                                {property.propertyData?.location || 'Dubai, UAE'}
                              </div>
                          ...
                          <div className="flex items-center gap-8">
                            <div>
                              <p className="text-xs text-neutral-500 uppercase tracking-wider mb-1">{pricing.label}</p>
                              <p className="text-xl font-light text-white">{pricing.value} OPN</p>
                              <p className="text-xs text-neutral-500">≈ ${pricing.usd}</p>
                            </div>
                            
                            <div>
                              <p className="text-xs text-neutral-500 uppercase tracking-wider mb-1">Available</p>
                              <p className="text-xl font-light text-white">{availability.value}</p>
          ...
          {!loading && filteredAndSortedProperties.length === 0 && (
            <div className="text-center py-32">
              <div className="inline-flex p-6 bg-neutral-900/50 rounded-full mb-6">
                <Building className="w-16 h-16 text-neutral-600" />
              </div>
