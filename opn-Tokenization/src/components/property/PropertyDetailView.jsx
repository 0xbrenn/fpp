...
// PREMIUM DARK THEME - Matching SecondaryMarketplace design
      ...
      return (
        <div className="bg-neutral-900/50 backdrop-blur-sm border border-neutral-800 rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-base font-medium text-white">Vehicle Information</h3>
          </div>
          <div className="grid grid-cols-2 gap-4">
            {year && (
              <div>
                <p className="text-[11px] text-neutral-500 uppercase tracking-wider font-medium mb-1">Year</p>
                <p className="text-white text-sm">{year}</p>
              </div>
            )}
            {make && (
              <div>
                <p className="text-[11px] text-neutral-500 uppercase tracking-wider font-medium mb-1">Make</p>
                <p className="text-white text-sm">{make}</p>
              </div>
            )}
            {vehicleModel && (
              <div>
                <p className="text-[11px] text-neutral-500 uppercase tracking-wider font-medium mb-1">Model</p>
                <p className="text-white text-sm">{vehicleModel}</p>
              </div>
            )}
            {vin && (
              <div className="col-span-2">
                <p className="text-[11px] text-neutral-500 uppercase tracking-wider font-medium mb-1">VIN</p>
                <p className="text-white font-mono text-xs bg-black/30 p-2 rounded-lg">{vin}</p>
              </div>
            )}
          </div>
        </div>
      ...
      return (
        <div className="bg-neutral-900/50 backdrop-blur-sm border border-neutral-800 rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-base font-medium text-white">Property Information</h3>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-[11px] text-neutral-500 uppercase tracking-wider font-medium mb-1">Location</p>
              <p className="text-white text-sm">{location || 'Dubai, United Arab Emirates'}</p>
            </div>
            <div>
              <p className="text-[11px] text-neutral-500 uppercase tracking-wider font-medium mb-1">Property Type</p>
              <p className="text-white text-sm">{propertyType || 'Real Estate'}</p>
            </div>
            <div>
              <p className="text-[11px] text-neutral-500 uppercase tracking-wider font-medium mb-1">Size</p>
              <p className="text-white text-sm">{size || 'Not specified'}</p>
            </div>
            <div>
              <p className="text-[11px] text-neutral-500 uppercase tracking-wider font-medium mb-1">Year Built</p>
              <p className="text-white text-sm">{yearBuilt || 'Not specified'}</p>
            </div>
          </div>
        </div>
      );
    ...
    return (
      <div className="bg-neutral-900/50 backdrop-blur-sm border border-neutral-800 rounded-2xl p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-base font-medium text-white">Asset Details</h3>
        </div>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <p className="text-[11px] text-neutral-500 uppercase tracking-wider font-medium mb-1">Asset Type</p>
            <p className="text-white text-sm">{property.assetType}</p>
          </div>
          <div>
            <p className="text-[11px] text-neutral-500 uppercase tracking-wider font-medium mb-1">Asset ID</p>
            <p className="text-white text-sm">#{property.assetId}</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="relative h-[400px] bg-gradient-to-b from-neutral-900 to-black overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-8">
          <div className="max-w-[1920px] mx-auto">
            ...
            <h1 className="text-2xl lg:text-3xl font-light text-white mb-2">{property.assetName}</h1>
      ...
      <div className="max-w-[1920px] mx-auto px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-neutral-900/50 backdrop-blur-sm border border-neutral-800 rounded-2xl p-6">
                  <div className="flex items-center gap-2 mb-6">
                    ...
                    <h3 className="text-base font-medium text-white">Investment Metrics</h3>
                  </div>
                  <div className="grid grid-cols-3 gap-8">
                    <div>
                      <p className="text-[11px] text-neutral-500 uppercase tracking-wider font-medium mb-2">
                        {isWeighted ? 'Price per 1%' : 'Price per Share'}
                      </p>
                      <p className="text-xl font-light text-white">{pricePerShare.toFixed(2)} OPN</p>
                      <p className="text-xs text-neutral-500 mt-0.5">≈ ${convertToUSD(pricePerShare)}</p>
                    </div>
                    <div>
                      <p className="text-[11px] text-neutral-500 uppercase tracking-wider font-medium mb-2">Holders</p>
                      <p className="text-xl font-light text-white">1</p>
                      <p className="text-xs text-neutral-500 mt-0.5">Active</p>
                    </div>
                    <div>
                      <p className="text-[11px] text-neutral-500 uppercase tracking-wider font-medium mb-2">Min. Investment</p>
                      ...
                      <p className="text-xs text-neutral-500 mt-0.5">{isWeighted ? 'ownership' : 'shares'}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeTab === 'details' && (
              <div className="space-y-6">
                <div className="bg-gradient-to-b from-neutral-900 to-black border border-neutral-800 rounded-xl p-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between py-4 border-b border-neutral-800">
                      ...
                      <span className="text-white font-medium">#{property.assetId}</span>
                    </div>
                    <div className="flex justify-between py-4 border-b border-neutral-800">
                      <span className="text-neutral-400 flex items-center gap-2">
                    ...
                    <div className="flex justify-between py-4 border-b border-neutral-800">
                      ...
                      <div className="text-right">
                        <p className="text-white font-medium">{totalValue.toFixed(0)} OPN</p>
                        <p className="text-sm text-neutral-500">≈ ${convertToUSD(totalValue)}</p>
                      </div>
                    </div>
                    {!isWeighted && (
            ...
            {activeTab === 'documents' && (
              <div className="bg-gradient-to-b from-neutral-900/50 to-black border border-neutral-800 rounded-xl p-16">
                <div className="text-center">
                          ...
                          <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-neutral-500">{tx.timestamp}</p>
                              </div>
                            </div>
            ...
            <div className="sticky top-6">
              <div className="bg-neutral-900/50 backdrop-blur-sm border border-neutral-800 rounded-2xl p-6">
                ...
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <h3 className="text-lg font-medium text-white">Ownership Distribution</h3>
                </div>
                ...
                <div className="space-y-4 mb-8">
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm text-white">{formatPercentage(soldPercentage)}</span>
                    </div>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm text-green-400">{formatPercentage(availablePercentage)}</span>
                    </div>
                    <div className="h-1.5 bg-neutral-800 rounded-full overflow-hidden">
                      <div 
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-neutral-500">≈ ${convertToUSD(pricePerShare)} USD</p>
                  </div>
                </div>
