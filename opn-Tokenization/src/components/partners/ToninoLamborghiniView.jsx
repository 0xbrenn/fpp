      ...
      for (let i = 0; i < assetIds.length; i++) {
        try {
          ...
          if (metadata.partner === 'tonino-lamborghini') {
           ...
           // In ToninoLamborghiniView.jsx
// Around line 150-180 where you build the partnerAssets.push() object
// Replace the purchase limits section with this:
...
partnerAssets.push({
  ...
  // ✅ FIXED: Convert purchase limits based on model
  ...(isWeighted ? {
