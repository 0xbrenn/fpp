...
// ENHANCED - Featured Partners Section with Premium Styling
...
const Sidebar = ({ isCollapsed, toggleSidebar, activeView, setActiveView, isMobileMenuOpen, setIsMobileMenuOpen }) => {
  ...
  // Featured Partners - These get special treatment
              ...
              {featuredPartners.map((partner) => {
                ...
                return (
                  <button
                    ...
                    title={isCollapsed ? partner.label : ''}
                  >
