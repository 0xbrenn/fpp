...
for (const posId of positionIds) {
  ...
  // ✅ FIX: Calculate weighted average purchase price
  // purchasePrice is the TOTAL paid for this position (not per unit)
...
if ((asset.model || asset[7]) === 0) {
  // ✅ FIXED MODEL - USE CURRENT PRICE
  const totalSupply = asset.totalSupply || asset[8];
  
  // ✅ NEW: Get current market price (includes secondary market data)
  ...
  // ✅ WEIGHTED MODEL - USE CURRENT PRICE
...
// ✅ FIX: Use weighted purchase sum (what you actually paid for current holdings)
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-12">
        ...
        {/* Portfolio Summary - THEMED */}
        <div className="bg-black border border-neutral-900 rounded-xl p-8 mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {userAssets.map((asset) => (
                    ...
                    >
                      ...
                      {/* EXACT SAME DATA - Just themed styling */}
                      <div className="p-6">
                        <div className="mb-4">
                          <p className="text-xs font-normal uppercase tracking-wider text-neutral-500 mb-1">
                            {asset.assetType}
    ...
    {/* THEMED Actions - WITH CANCEL P2P LISTING */}
<div className="flex flex-col gap-2">
  <div className="flex gap-2">
    <button
      ...
      className="flex-1 px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white text-base font-normal rounded-xl transition-all shadow-lg shadow-blue-600/20"
    >
      Sell
    </button>
    {isAssetCreator(asset) && (
      <button
        ...
        className="px-4 py-3 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white text-base font-normal rounded-xl transition-all shadow-lg shadow-purple-600/20"
      >
  ...
  {/* Cancel P2P Listing Button - Warning style */}
  {positionListings[asset.assetId] && positionListings[asset.assetId].length > 0 && (
    <button
      ...
      className="w-full py-3 bg-yellow-500/10 hover:bg-yellow-500/20 border border-yellow-500/30 text-yellow-500 rounded-xl text-base font-normal transition-all flex items-center justify-center gap-2"
    >
      {cancellingListing ? (
        <>
