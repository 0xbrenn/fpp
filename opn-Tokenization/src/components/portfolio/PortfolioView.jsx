...
const PortfolioView = () => {
  ...
  // Fetch user's complete position data - NO PLACEHOLDERS
    ...
    try {
      ...
      const holdingsPromises = assetIds.map(async (assetId) => {
        try {
          ...
          // Get all position details and calculate totals
          ...
          if ((asset.model || asset[7]) === 0) {
            ...
            // WEIGHTED MODEL
            percentageOwned = totalAmount.toNumber() / 100;
            ...
            pricePerShare = ethers.utils.formatEther(totalValue.div(10000));
          }
          ...
          return {
            ...
            model: (asset.model || asset[7]), // 0 = FIXED, 1 = WEIGHTED
            location: "Global",
            pricePerShare,
  ...
  // Portfolio health based on diversification and performance
                  ...
                  {userAssets.map((asset) => (
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        {/* Actions - UPDATED WITH CANCEL P2P LISTING */}
                        <div className="flex flex-col gap-2">
                          {/* First Row - Sell and Create Proposal */}
                          ...
                          {/* Second Row - Cancel P2P Listing (only shows if asset is listed) */}
